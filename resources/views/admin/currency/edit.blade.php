            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.currency.index') }}">Currency Master</a>
                        </li>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.currency.update',$currencyData->id) }}" id="export_type_form"
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" name="name"
                                                ...
                                                value="{{ old('name') ? old('name') : $currencyData->name }}">
                                        </fieldset>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                     ...
                                     <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <select class="select2 form-control select2-hidden-accessible @error('userType') is-invalid @enderror" name="userType" id="userType">
                                                <option value="1" {{ ($currencyData->userType == '1') ? 'selected' : '' }}>Buyer</option>
                                                <option value="2" {{ ($currencyData->userType == '2') ? 'selected' : '' }}>Seller</option>
                                            </select>
                                        </fieldset>
                                    </div>
                                </div>
