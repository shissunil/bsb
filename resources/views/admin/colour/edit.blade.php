...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Edit Colour</h2>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Colour
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.colour.update',$colourData->id) }}" id="export_type_form"
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" name="name"
                                                ...
                                                value="{{ old('name') ? old('name') : $colourData->name }}">
                                        </fieldset>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <div class="input-group colorpicker-element">
                                                <input name="code" class="form-control input-block color-io @error('code') is-invalid @enderror" id="code" placeholder="Name..." value="{{ $colourData->code }}">
                                                <span class="input-group-append">
                                                    <span id="color_picker" class="input-group colorpicker-element"
                                                        title="Using input value">
                                                        <input type="hidden" class="form-control input-lg" value="{{ $colourData->code }}">
                                                        <span class="input-group-text colorpicker-input-addon"
                                                            data-original-title="" title="" tabindex="0">
                                                            <i style="background: {{ $colourData->code }}"></i>
                                                        </span>
                                                    </span>
                                                </span>
                                            </div>
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <select class="select2 form-control select2-hidden-accessible @error('status') is-invalid @enderror" name="status" id="status">
                                                <option value="1" {{ ($colourData->status == '1') ? 'selected' : '' }}>Active</option>
                                                <option value="0" {{ ($colourData->status == '0') ? 'selected' : '' }}>InActive</option>
                                            </select>
                                        </fieldset>
                                    </div>
                                     ...
                                     <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <select class="select2 form-control select2-hidden-accessible @error('userType') is-invalid @enderror" name="userType" id="userType">
                                                <option value="1" {{ ($colourData->userType == '1') ? 'selected' : '' }}>Buyer</option>
                                                <option value="2" {{ ($colourData->userType == '2') ? 'selected' : '' }}>Seller</option>
                                            </select>
                                        </fieldset>
                                    </div>
                                </div>
